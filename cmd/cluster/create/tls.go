...
func defaultTlsConfig(cmd *cobra.Command) *deployTlsOptions {
	o := &deployTlsOptions{
		enabled:      false,
		certData:     "",
		certFilename: "",
...
func (o *deployTlsOptions) setConfig(deployment *cluster.KubemqCluster) *deployTlsOptions {
	if !o.enabled {
		return o
	}
	deployment.Spec.Tls = &cluster.TlsConfig{
		Cert: o.certData,
		Key:  o.keyData,
		Ca:   o.caData,
	}
