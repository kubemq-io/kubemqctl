...
var defaultStoreConfig = &deployStoreOptions{
	clean:                    false,
	path:                     "./store",
	maxChannels:              0,
	maxSubscribers:           0,
...
func setStoreConfig(cmd *cobra.Command) *deployStoreOptions {
...
func (o *deployStoreOptions) setConfig(deployment *kubemqcluster.KubemqCluster) *deployStoreOptions {
	if isDefault(o, defaultStoreConfig) {
		return o
	}
