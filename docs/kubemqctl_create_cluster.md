...
```
  ...
  -c, --config-file string                         set kubemq config file
      ...
      --health-failure int32                       set health prob failure threshold (default 6)
      --health-initial-delay int32                 set health prob initial delay seconds  (default 5)
      --health-period int32                        set health prob period seconds  (default 10)
      --health-success int32                       set health prob success threshold (default 1)
      --health-timout int32                        set health prob timeout seconds  (default 5)
  -h, --help                                       help for cluster
      --image-pull-policy string                   set image pull policy (default "Always")
      --image-registry string                      set image registry (default "docker.io")
      --image-repository string                    set image repository (default "kubemq/kubemq")
  -T, --image-tag string                           set image tag (default "latest")
  ...
  -n, --name string                                set kubemq cluster name (default "kubemq-cluster")
      --namespace string                           set kubemq cluster namespace (default "kubemq")
