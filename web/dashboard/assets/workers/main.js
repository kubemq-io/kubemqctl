...
/***/ "./src/workers/app-workers/app.workers.ts":
/*!************************************************!*\
  !*** ./src/workers/app-workers/app.workers.ts ***!
  \************************************************/
...
/* harmony import */ var _shared_worker_message_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shared/worker-message.model */ "./src/workers/app-workers/shared/worker-message.model.ts");
/* harmony import */ var _shared_worker_topic_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shared/worker-topic.constants */ "./src/workers/app-workers/shared/worker-topic.constants.ts");
/* harmony import */ var _shared_mocked_cpu_intensive_worker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shared/mocked-cpu-intensive.worker */ "./src/workers/app-workers/shared/mocked-cpu-intensive.worker.ts");
/* harmony import */ var _shared_socket_worker__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shared/socket-worker */ "./src/workers/app-workers/shared/socket-worker.ts");
/* harmony import */ var _shared_db_worker__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./shared/db.worker */ "./src/workers/app-workers/shared/db.worker.ts");
...
var AppWorkers = /** @class */ (function () {
    function AppWorkers(workerCtx) {
        _shared_socket_worker__WEBPACK_IMPORTED_MODULE_3__["SocketWorker"].initiateLocalDB();
        this.workerCtx = workerCtx;
        this.created = new Date();
    }
    AppWorkers.prototype.workerBroker = function ($event) {
        var _a = $event.data, topic = _a.topic, data = _a.data;
        var workerMessage = new _shared_worker_message_model__WEBPACK_IMPORTED_MODULE_0__["WorkerMessage"](topic, data);
        switch (topic) {
            case _shared_worker_topic_constants__WEBPACK_IMPORTED_MODULE_1__["WORKER_TOPIC"].addData:
                _shared_db_worker__WEBPACK_IMPORTED_MODULE_4__["IndexedDbWorker"].addItem();
                break;
            case _shared_worker_topic_constants__WEBPACK_IMPORTED_MODULE_1__["WORKER_TOPIC"].openDB:
                _shared_db_worker__WEBPACK_IMPORTED_MODULE_4__["IndexedDbWorker"].openDB();
                break;
            case _shared_worker_topic_constants__WEBPACK_IMPORTED_MODULE_1__["WORKER_TOPIC"].getSnapshot:
                this.returnWorkResults(new _shared_worker_message_model__WEBPACK_IMPORTED_MODULE_0__["WorkerMessage"]('test', _shared_socket_worker__WEBPACK_IMPORTED_MODULE_3__["SocketWorker"].getSnapshotData()));
                break;
            case _shared_worker_topic_constants__WEBPACK_IMPORTED_MODULE_1__["WORKER_TOPIC"].openSocket:
                _shared_socket_worker__WEBPACK_IMPORTED_MODULE_3__["SocketWorker"].openSocket('ws://localhost:8080/v1/stats/dashboard/stream?node=avihai-pc');
                break;
            case _shared_worker_topic_constants__WEBPACK_IMPORTED_MODULE_1__["WORKER_TOPIC"].cpuIntensive:
                this.returnWorkResults(_shared_mocked_cpu_intensive_worker__WEBPACK_IMPORTED_MODULE_2__["MockedCpuIntensiveWorker"].doWork(workerMessage));
                break;
    ...
    AppWorkers.prototype.sendToLocalDB = function () {
    };
    return AppWorkers;
}());
...
/***/ "./src/workers/app-workers/shared/db.worker.ts":
/*!*****************************************************!*\
  !*** ./src/workers/app-workers/shared/db.worker.ts ***!
  \*****************************************************/
/*! exports provided: IndexedDbWorker */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IndexedDbWorker", function() { return IndexedDbWorker; });
var IndexedDbWorker = /** @class */ (function () {
    function IndexedDbWorker() {
    }
    IndexedDbWorker.openDB = function () {
        var openRequest = indexedDB.open('test_db', 2);
        openRequest.onupgradeneeded = function (e) {
            IndexedDbWorker.db = e.target.result;
            console.log('running onupgradeneeded');
            if (!this.objectStoreNames.contains('store')) {
                var storeOS = this.createObjectStore('store', { keyPath: 'name' });
            }
        };
        openRequest.onsuccess = function (e) {
            console.log('running onsuccess');
            IndexedDbWorker.db = e.target.result;
            //IndexedDbWorker.addItem();
        };
    ...
    IndexedDbWorker.addItem = function () {
        var transaction = IndexedDbWorker.db.transaction(['store'], 'readwrite');
        var store = transaction.objectStore('store');
        var item = {
            name: 'bananaasda',
            price: '$2.99asda',
            description: 'It is a purple baasdananaa!',
...
/***/ "./src/workers/app-workers/shared/mocked-cpu-intensive.worker.ts":
/*!***********************************************************************!*\
  !*** ./src/workers/app-workers/shared/mocked-cpu-intensive.worker.ts ***!
  \***********************************************************************/
...
/* harmony import */ var _worker_message_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./worker-message.model */ "./src/workers/app-workers/shared/worker-message.model.ts");
...
var MockedCpuIntensiveWorker = /** @class */ (function () {
    ...
    MockedCpuIntensiveWorker.doWork = function (value) {
        ...
        return new _worker_message_model__WEBPACK_IMPORTED_MODULE_0__["WorkerMessage"](value.topic, { iteration: count });
    };
...
/***/ "./src/workers/app-workers/shared/socket-worker.ts":
/*!*********************************************************!*\
  !*** ./src/workers/app-workers/shared/socket-worker.ts ***!
  \*********************************************************/
/*! exports provided: SocketWorker */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SocketWorker", function() { return SocketWorker; });
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");

var SocketWorker = /** @class */ (function () {
    function SocketWorker() {
    }
    SocketWorker.initiateLocalDB = function () {
    };
    SocketWorker.openSocket = function (url) {
        SocketWorker.subject = SocketWorker.create(url);
        console.log("Successfully connected: " + url);
        SocketWorker.messages = SocketWorker.subject;
        SocketWorker.messageHandlers();
    };
    SocketWorker.create = function (url) {
        var ws = new WebSocket(url);
        ws.onmessage = function (event) {
        };
        var observable$ = rxjs__WEBPACK_IMPORTED_MODULE_0__["Observable"].create(function (obs) {
    ...
    SocketWorker.messageHandlers = function () {
        var _this = this;
        setTimeout(function () {
            _this.sendMessage('start');
            SocketWorker.messages.subscribe(function (msg) {
                if (msg.data !== 'avihai-pc Server connected.') {
                    SocketWorker.snapshotData.push(JSON.parse(msg.data));
                }
            });
        }, 3000);
    };
    SocketWorker.sendMessage = function (msg) {
        this.messages.next(msg);
    };
    SocketWorker.getSnapshotData = function () {
        return SocketWorker.snapshotData;
    };
    SocketWorker.snapshotData = [];
    return SocketWorker;
}());
...
/***/ "./src/workers/app-workers/shared/worker-message.model.ts":
/*!****************************************************************!*\
  !*** ./src/workers/app-workers/shared/worker-message.model.ts ***!
  \****************************************************************/
...
/***/ "./src/workers/app-workers/shared/worker-topic.constants.ts":
/*!******************************************************************!*\
  !*** ./src/workers/app-workers/shared/worker-topic.constants.ts ***!
  \******************************************************************/
...
/* harmony import */ var _app_workers_app_workers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app-workers/app.workers */ "./src/workers/app-workers/app.workers.ts");
...
/***/ 0:
/*!******************************************!*\
  !*** multi ./src/workers/main.worker.ts ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./src/workers/main.worker.ts */"./src/workers/main.worker.ts");
